...
const AW_PLACES = [
  ...
  { id:'le-pelican-annecy', kind:'spot', name:'Le Pélican', city:'Annecy', types:['spot','daily','meeting'], coords:[45.8965,6.1335], priceFrom:13,
    equip:{ fr:['Wi-Fi','Bar / lounge','Day-office & salle de réunion','Bord du lac'], en:['Wi-Fi','Bar / lounge','Day-office & meeting room','Lakeside'] },
    dispo:{ fr:'Lun–Ven · 9h–18h', en:'Mon–Fri · 9am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salle de réunion, partenaire. Le Pélican a Annecy (20 Rue des Marquisats), pres du lac : lounge, day-office et salle de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting room, partner. Le Pélican in Annecy (20 Rue des Marquisats), near the lake: lounge, day-office and meeting room." },
    photo:{ fr:'PHOTO — Le Pelican Annecy', en:'PHOTO — Le Pelican Annecy' } },

  { id:'le-rivage-annecy', kind:'spot', name:'Le Rivage', city:'Annecy-le-Vieux', types:['spot','daily','meeting'], coords:[45.9105,6.1490], priceFrom:13,
    equip:{ fr:['Wi-Fi','Bar / lounge','Day-office & salle de réunion','Bord du lac'], en:['Wi-Fi','Bar / lounge','Day-office & meeting room','Lakeside'] },
    dispo:{ fr:'Lun–Ven · 9h–18h', en:'Mon–Fri · 9am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salle de réunion, partenaire. Le Rivage au Petit Port (33 Av. du Petit Port, Annecy-le-Vieux), au bord du lac : lounge, day-office et salle de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting room, partner. Le Rivage at Petit Port (33 Av. du Petit Port, Annecy-le-Vieux), by the lake: lounge, day-office and meeting room." },
    photo:{ fr:'PHOTO — Le Rivage Petit Port Annecy', en:'PHOTO — Le Rivage Petit Port Annecy' } },

  { id:'hotel-la-chapelle-annecy', kind:'hotel', name:'Hôtel La Chapelle', city:'Annecy', types:['spot','daily','meeting'], coords:[45.9015,6.1050], priceFrom:38,
    equip:{ fr:['Wi-Fi','Lounge / bar','Day-office & salle de réunion','Parking'], en:['Wi-Fi','Lounge / bar','Day-office & meeting room','Parking'] },
    dispo:{ fr:'Lun–Ven · 8h–18h', en:'Mon–Fri · 8am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salle de réunion, partenaire. Hôtel La Chapelle a Annecy (9 Av. de Cran) : lounge, day-office et salle de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting room, partner. Hôtel La Chapelle in Annecy (9 Av. de Cran): lounge, day-office and meeting room." },
    photo:{ fr:'PHOTO — Hotel La Chapelle Annecy', en:'PHOTO — Hotel La Chapelle Annecy' } },

  { id:'geneva-marriott', kind:'hotel', name:'Geneva Marriott Hotel', city:'Genève (Cointrin)', types:['spot','daily','meeting'], coords:[46.2270,6.1080], priceFrom:38,
    equip:{ fr:['Wi-Fi','Lounge / bar','Day-office & salles de réunion','Proche aéroport'], en:['Wi-Fi','Lounge / bar','Day-office & meeting rooms','Near airport'] },
    dispo:{ fr:'Lun–Ven · 8h–18h', en:'Mon–Fri · 8am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salles de réunion, partenaire. Geneva Marriott Hotel a Cointrin (Chemin du Ruisseau 1), proche de l'aeroport : lounge, day-office et salles de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting rooms, partner. Geneva Marriott Hotel in Cointrin (Chemin du Ruisseau 1), near the airport: lounge, day-office and meeting rooms." },
    photo:{ fr:'PHOTO — Geneva Marriott Cointrin', en:'PHOTO — Geneva Marriott Cointrin' } },

  { id:'hotel-cornavin-geneve', kind:'hotel', name:'Hôtel Cornavin', city:'Genève', types:['spot','daily','meeting'], coords:[46.2105,6.1420], priceFrom:38,
    equip:{ fr:['Wi-Fi','Lounge / bar','Day-office & salles de réunion','Gare Cornavin'], en:['Wi-Fi','Lounge / bar','Day-office & meeting rooms','Cornavin station'] },
    dispo:{ fr:'Lun–Ven · 8h–18h', en:'Mon–Fri · 8am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salles de réunion, partenaire. Hôtel Cornavin a Genève (Bd James-Fazy 23), face a la gare : lounge, day-office et salles de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting rooms, partner. Hôtel Cornavin in Geneva (Bd James-Fazy 23), by the station: lounge, day-office and meeting rooms." },
    photo:{ fr:'PHOTO — Hotel Cornavin Geneve', en:'PHOTO — Hotel Cornavin Geneva' } },

  { id:'hood-hotel-geneve', kind:'hotel', name:'HOOD Hôtel', city:'Genève (Eaux-Vives)', types:['spot','daily'], coords:[46.2010,6.1660], priceFrom:38,
    equip:{ fr:['Wi-Fi','Lounge / bar','Day-office','Gare des Eaux-Vives'], en:['Wi-Fi','Lounge / bar','Day-office','Eaux-Vives station'] },
    dispo:{ fr:'Lun–Ven · 8h–18h', en:'Mon–Fri · 8am–6pm' },
    desc:{ fr:"AltiusSpot & AltiusHub, partenaire. HOOD Hôtel a Genève (Av. de la Gare des Eaux-Vives 29A) : lounge et day-office privatisable.",
           en:"AltiusSpot & AltiusHub, partner. HOOD Hôtel in Geneva (Av. de la Gare des Eaux-Vives 29A): lounge and day-office." },
    photo:{ fr:'PHOTO — HOOD Hotel Geneve', en:'PHOTO — HOOD Hotel Geneva' } },

  { id:'ramada-encore-geneve', kind:'hotel', name:'Ramada Encore Genève', city:'Genève (Lancy)', types:['spot','daily','meeting'], coords:[46.1875,6.1240], priceFrom:38,
    equip:{ fr:['Wi-Fi','Lounge / bar','Day-office & salles de réunion','Proche La Praille'], en:['Wi-Fi','Lounge / bar','Day-office & meeting rooms','Near La Praille'] },
    dispo:{ fr:'Lun–Ven · 8h–18h', en:'Mon–Fri · 8am–6pm' },
    desc:{ fr:"AltiusSpot, AltiusHub & salles de réunion, partenaire. Ramada Encore a Genève (Rte des Jeunes, Lancy) : lounge, day-office et salles de reunion privatisables.",
           en:"AltiusSpot, AltiusHub & meeting rooms, partner. Ramada Encore in Geneva (Rte des Jeunes, Lancy): lounge, day-office and meeting rooms." },
    photo:{ fr:'PHOTO — Ramada Encore Geneve', en:'PHOTO — Ramada Encore Geneva' } },
